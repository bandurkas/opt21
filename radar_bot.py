                ...
                for opp in opps:
                    ...
                    if sig_id not in sent_signals:
                        ...
                        msg = (
                            ...
                            f"Как только вашу лимитку заберут на {opp['wide_exchange']}, **немедленно** откройте биржу *{opp['tight_exchange']}* и нажмите **SELL (Продать по рынку)** этот же самый опцион.\n"
                            f"Справедливая цена продажи там сейчас: *${opp['fair_price']:.2f}*.\n"
